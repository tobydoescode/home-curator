...
- `docs/policies.md` — **writing policies**: rule types, naming presets, CEL reference
...
- `task lint` — ruff + mypy + tsc
- `task check` — lint plus both test suites (what CI gates on)
